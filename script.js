...
const snakeLivesElement = document.querySelector(".lives");
...
const render = () => {
  ...
  snakeLivesElement.innerHTML = `Lives: ${snakeLives}`;
};
/*
...
const protocolExecutor = () => {
  ...
  switch (event) {
    ...
    case "lost live":
      snakeLives -= 1;
      if (snakeLives <= 0) {
        setEvent("game over", "no lives left");
        break;
      }
      snakeX = 5;
      snakeY = 10;
